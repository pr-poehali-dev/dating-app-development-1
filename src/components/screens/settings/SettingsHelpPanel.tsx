      ...
      {helpSub === "" && (
        <div className="px-5 flex flex-col gap-3">
          {([
            ...
            { icon: "Info",          title: "О приложении",               sub: "Полутон v1.0",                       id: ""         },
          ] as const).map((item) => (
