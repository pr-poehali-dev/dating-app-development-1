        ...
        <div className="px-5 flex flex-col gap-4">
          ...
          <div className="glass-card p-5 flex flex-col gap-5">
            ...
            {([
              ...
              { title: "8. Контакты", text: "По вопросам обработки персональных данных обращайтесь: info@lbloom.ru. Ответ предоставляется в течение 10 рабочих дней." },
