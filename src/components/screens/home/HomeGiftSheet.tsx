            ...
            {GIFTS.filter(g => g.category === giftCategory).map((gift) => {
              ...
              return (
                <button key={gift.id}
                  ...
                  <GiftItem category={gift.category as "heart"|"rose"|"bear"|"ring"|"special"} variant={gift.variant ?? 0} animKey={gift.anim} size={54} rarity={gift.rarity as "common"|"rare"|"epic"|"legendary"} selected={selected} />
