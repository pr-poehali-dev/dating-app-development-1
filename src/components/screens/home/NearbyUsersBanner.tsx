              ...
              <div
                ...
                {!isLocked && (
                  <button
                    ...
                    className={`w-full py-1 rounded-lg text-[9px] font-bold transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center gap-1 ${isSub ? "text-white/40" : "text-white"}`}
                    style={isSub
