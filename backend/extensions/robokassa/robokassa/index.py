...
def handler(event: dict, context) -> dict:
    ...
    try:
        ...
        plan = str(payload.get('plan', '1month'))
        ...
        cur.execute("""
            INSERT INTO orders (order_number, user_id, user_name, user_email, user_phone, amount, robokassa_inv_id, status, delivery_address, order_comment, plan)
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
            RETURNING id
        """, (order_number, user_id, user_name, user_email, user_phone, round(amount, 2), robokassa_inv_id, 'pending', user_address, order_comment, plan))
