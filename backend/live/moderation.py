...
Проверка текста чата live-трансляции через chat.completions с JSON-ответом.
...
def moderate_text(text: str) -> dict:
    ...
    try:
        prompt = (
            ...
            "score — степень уверенности что текст нарушает правила (0 = точно норм, 100 = точное нарушение: спам, мат/оскорбления, "
            "мошенничество, сексуальный контент, реклама, попытка увести из приложения). "
